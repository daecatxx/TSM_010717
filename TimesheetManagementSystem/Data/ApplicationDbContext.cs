...
namespace TimeSheetManagementSystem.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            // optionsBuilder.UseSqlServer(@"Server=ILOVECODE\SQLEXPRESS;database=TimeSheetManagementSystemDB_v3;Trusted_Connection=True;MultipleActiveResultSets=True");
            optionsBuilder.UseSqlServer(@"Server=AISYAH\SQLEXPRESS;database=TimeSheetManagementDB_V10;Trusted_Connection=True;MultipleActiveResultSets=True");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountDetail>()
                ...
                .IsRequired(true);
            modelBuilder.Entity<AccountDetail>()
                .HasIndex(input => new { input.DayOfWeekNumber, input.CustomerAccountId, input.StartTimeInMinutes, input.EndTimeInMinutes })
                .IsUnique()
                .HasName("AccountDetail_UniqueConstraint");
