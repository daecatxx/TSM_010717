        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(nullable: false, defaultValueSql: "GetDate()"),
                    CreatedByName = table.Column<string>(type: "VARCHAR(100)", nullable: false),
                    ...
                    TimeInInMinutes = table.Column<int>(nullable: true),
                    TimeOutInMinutes = table.Column<int>(nullable: true),
                    TimeSheetId = table.Column<int>(nullable: false),
                    UpdatedAt = table.Column<DateTime>(nullable: false, defaultValueSql: "GetDate()"),
                    UpdatedByName = table.Column<string>(type: "VARCHAR(100)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "AccountDetail_UniqueConstraint",
                table: "AccountDetail",
                columns: new[] { "DayOfWeekNumber", "CustomerAccountId", "StartTimeInMinutes", "EndTimeInMinutes" },
                unique: true);
